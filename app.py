...
async def run_task(task: str):
    try:
        ...
        elif "Check if the file path" in task and "using B12" in task:
        # parse the filepath/output filename from the instruction
             filepath = "/data/test-valid.txt"
             output_filename = "/data/b12-valid.txt"

             B12_check_path(filepath, output_filename)
             return {"message": "B12 Task executed successfully"}
        if "B3" == task_code:
